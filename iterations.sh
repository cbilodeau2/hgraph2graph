...
predictor1=predictors/solubility_9-16-20
predictor1_path=`cat predictors/solubility_9-16-20/path.txt`
...
n_epochs=1
fin_model=model.0 # Max is n_epochs-1, model will be used for generation and starting checkpoint
num_decode=4 # Number of molecules to generate (per molecule) at each generation step
